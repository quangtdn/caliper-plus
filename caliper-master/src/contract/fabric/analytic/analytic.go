...
func send(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var val int
	var err error
...
func commit(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var err error
	var tip int
...
func (t *Analytic) Init(stub shim.ChaincodeStubInterface) sc.Response {
...
func (t *Analytic) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
...
func query_block(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var err error
	var tip, req int
	var valAsbytes []byte
	tip, err = get_tip(stub)
...
// @arg1 account
// @arg2 block num
func query_account(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var err error
	var tip, req_blk int
	req_acc := args[0]
	tip, err = get_tip(stub)
...
// @arg2 start_block
// @arg3 end_block
func range_account(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var err error
...
func (t *Analytic) Query(stub shim.ChaincodeStubInterface) sc.Response {
	function, args := stub.GetFunctionAndParameters()
