...
module.exports.run = function() {
    ...
    if (bc.bcType === 'fabric-ccp') {
        ...
        for (let arg of args) {
            ...
            client_id = 1+Math.floor(Math.random() * Math.floor(no_clients/2));
            let testing_client = 'client0.org'+client_id.toString()+'.example.com';
          //  console.log(testing_client);

            ccpArgs.push({
                chaincodeFunction: arg.transaction_type,
                chaincodeArguments: functionArgs,
                invokerIdentity: testing_client
            });
        }
